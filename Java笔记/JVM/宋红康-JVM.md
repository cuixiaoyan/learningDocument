...
<img src="https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200924145254035.png" alt="image-20200924145254035" style="zoom:50%;" />
...
![image-20200924150232747](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200924150232747.png)
...
- 如果养老区执行了Major GC之后，发现依然无法进行对象的保存，就会产生OOM异常。
...
Major GC的速度一般会比==MinorGc慢10倍==以上，STW的时间更长，如果Major GC后，内存还不足，就报OOM了

### Full GC

触发FullGC执行的情况有如下五种：

- 调用System.gc（）时，系统建议执行FullGC，但是不必然执行(不可控)
- 老年代空间不足
- 方法区空间不足
...
![image-20200709095356247](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709095356247.png)
...
![image-20200709151033237](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709151033237.png)
...
![image-20200709152801713](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709152801713.png)
...
![image-20200709164149920](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709164149920.png)

### 对象访问的两种方式

#### 句柄访问

![image-20200709164342002](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709164342002.png)
...
![image-20200709164350466](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709164350466.png)
...
![image-20200709170907611](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709170907611.png)
...
![image-20200709230647277](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200709230647277.png)
...
![image-20200710080707873](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710080707873.png)
...
![image-20200710081118053](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710081118053.png)

那么，如果想要让一个Java程序运行起来，执行引擎（Execution Engine）的任务就是将字节码指令解释/编译为对应平台上的本地机器指令才可以。简单来说，JVM中的执行引擎充当了将高级语言翻译为机器语言的译者。

![image-20200710081259276](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710081259276.png)
...
![image-20200710081627217](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710081627217.png)
...
![image-20200710082141643](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710082141643.png)

Java代码编译是由Java源码编译器来完成，流程图如下所示：

![image-20200710082433146](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710082433146.png)

Java字节码的执行是由JVM执行引擎来完成，流程图 如下所示

![image-20200710083036258](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710083036258.png)

我们用一个总的图，来说说 解释器和编译器。

![image-20200710083656277](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710083656277.png)
...
![image-20200710085323733](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710085323733.png)
...
![image-20200710085553258](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710085553258.png)
...
![image-20200710090203674](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710090203674.png)
...
![image-20200710095417462](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710095417462.png)
...
![image-20200710101829934](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710101829934.png)
...
![image-20200710103103869](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710103103869.png)
...
![image-20200710103340273](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200710103340273.png)
...
- String：字符串，使用一对 ”” 引起来表示
  - String s1 = "cxy" ; // 字面量的定义方式
  - String s2 = new String("cuixiaoyan");
...
![image-20200711093546398](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200711093546398.png)

![image-20200711093558709](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200711093558709.png)
...
而调用intern方法，则会判断字符串常量池中是否存在JavaEEhadoop值，如果存在则返回常量池中的值，否则就在常量池中创建。

### 底层原理

拼接操作的底层其实使用了StringBuilder

![image-20200711102231129](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200711102231129.png)
...
![image-20200711145925091](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200711145925091.png)
...
![image-20200711150859709](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200711150859709.png)
...
![image-20200711151326909](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200711151326909.png)

针对下面这题，在JDK6和8中表现的是一样的

![image-20200711151433277](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200711151433277.png)
...
![image-20200712084539884](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712084539884.png)

## 什么是垃圾

在提到什么是垃圾之前，我们先看下面一张图

![image-20200712085456113](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712085456113.png)
...
![image-20200712090848669](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712090848669.png)
...
![image-20200712092427246](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712092427246.png)
...
![image-20200712102205795](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712102205795.png)
...
![image-20200712103230349](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712103230349.png)
...
![image-20200712104149246](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712104149246.png)

官场上的裙带关系，可达性分析在人类关系网中

![image-20200712104312406](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712104312406.png)
...
![image-20200712104622677](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712104622677.png)
...
![image-20200712110411885](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712110411885.png)
...
![image-20200712112026317](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712112026317.png)
...
![image-20200712112512720](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712112512720.png)
...
![image-20200712113256075](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712113256075.png)
...
![image-20200712150229048](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712150229048.png)

然后我们通过线程，还能够定位到哪里出现OOM

![image-20200712150303710](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712150303710.png)
...
![image-20200712150935078](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712150935078.png)
...
![image-20200712151916991](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712151916991.png)

把可达的对象，直接复制到另外一个区域中复制完成后，A区就没有用了，里面的对象可以直接清除掉，其实里面的新生代里面就用到了复制算法

![image-20200712152029615](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712152029615.png)
...
![image-20200712152847218](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712152847218.png)
...
![image-20200712153236508](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712153236508.png)
...
![image-20200712165318590](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712165318590.png)
...
![image-20200712195158470](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712195158470.png)
...
![image-20200712202522051](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712202522051.png)
...
![image-20200712202822129](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712202822129.png)
...
![image-20200712203607845](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712203607845.png)
...
![image-20200712203815517](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712203815517.png)
...
.![image-20200712205813321](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712205813321.png)
...
![image-20200712211501377](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712211501377.png)
...
![image-20200712211732976](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200712211732976.png)
...
![image-20200713083030867](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713083030867.png)
...
![image-20200713083443486](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713083443486.png)
...
![image-20200713084726176](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713084726176.png)
...
![image-20200713085306400](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713085306400.png)
...
![image-20200713093551365](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713093551365.png)

### 7款经典收集器与垃圾分代之间的关系

![image-20200713093757644](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713093757644.png)
...
![image-20200713094745366](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713094745366.png)
...
![image-20200713100703799](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713100703799.png)
...
![image-20200713102030127](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713102030127.png)
...
![image-20200713110359441](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713110359441.png)
...
![image-20200713205154007](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713205154007.png)
...
![image-20200713212230352](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713212230352.png)
...
![image-20200713215105293](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713215105293.png)

而是这样的一个区域

![image-20200713215133839](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713215133839.png)
...
![image-20200713223244886](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713223244886.png)
...
![image-20200713223509993](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713223509993.png)
...
![image-20200713224113996](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713224113996.png)
...
![image-20200713224716715](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713224716715.png)
...
![image-20200713225100632](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713225100632.png)
...
![image-20200713225810871](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200713225810871.png)
...
![image-20200714075738203](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714075738203.png)

GC发展阶段：Seria l=> Parallel（并行）=> CMS（并发）=> G1 => ZGC

不同厂商、不同版本的虚拟机实现差距比较大。HotSpot虚拟机在JDK7/8后所有收集器及组合如下图

![image-20200714080151020](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714080151020.png)
...
![image-20200714081610474](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714081610474.png)

参数解析

![image-20200714081622526](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714081622526.png)
...
![image-20200714081909309](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714081909309.png)

参数解析

![image-20200714081925767](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714081925767.png)
...
![image-20200714082555688](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714082555688.png)

### FullGC图片、

![image-20200714082714690](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714082714690.png)
...
![image-20200714083332238](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714083332238.png)

然后我们将4M对象存入到Eden区中

![image-20200714083526790](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714083526790.png)
...
![image-20200714084921184](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714084921184.png)

**GC easy**

![image-20200714084726824](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714084726824.png)
...
![image-20200714090608807](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714090608807.png)
...
![image-20200714091201073](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714091201073.png)

停顿时间对比

![image-20200714091401511](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714091401511.png)

虽然ZGC还在试验状态，没有完成所有特性，但此时性能已经相当亮眼，用“令人震惊、革命性”来形容，不为过。 未来将在服务端、大内存、低延迟应用的首选垃圾收集器。

![image-20200714093243028](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714093243028.png)
...
![image-20200714093604012](https://gitee.com/cuixiaoyan/uPic/raw/master/uPic/image-20200714093604012.png)
